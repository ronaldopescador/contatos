...
namespace SistemaContatos.Controllers
{
    public class ContatoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Celular")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Celular")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
